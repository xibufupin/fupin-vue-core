...
export default class Instance {
	...
	public system: any = ref("");

	public command: any = ref("");
	...
	private setOption(option) {
		...
		if (option.hasOwnProperty('system')) this.system.value = option.system;
		if (option.hasOwnProperty('command')) this.command.value = option.command;
	}
